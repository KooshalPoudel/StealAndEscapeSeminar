...
private:
	...
	*/
	...
	/* Hearing configuration for the guard AI. This allows the guard to detect
	   noise events such as player footsteps and respond by investigating the sound location
	*/
	UPROPERTY()
